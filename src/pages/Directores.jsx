                ...
                <tbody>
                    {listaDirectores.map(item =>
                        <tr key={item.iddirector}>
                            ...
                            <td><i className="bi bi-pencil-fill"
                                title="Editar"
                    ...
                    <div className="modal-content">
                        ...
                        <form onSubmit={(event) => insertDirector(event)}>
                            <div className="modal-body">
                                <div className="mb-3">
                                    <input type="text" className="form-control" placeholder="Nombres del director"
                            ...
                            <div className="modal-body">
                                <div className="mb-3">
                                    <input type="text" className="form-control"
                                        readOnly
                                        value={iddirector} onChange={(event) => setIddirector(event.target.value)} />
                                </div>
                                <div className="mb-3">
                                    <input type="text" className="form-control" placeholder="Nombres del director"
                                        required minLength="5"
